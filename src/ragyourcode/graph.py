...
def graph_search(
    ...
    seeds = search(units, query, max(limit * 2, 8), search_index=search_index, vector_weight=vector_weight, vector_recall=vector_recall, min_coverage=min_coverage, min_concentration=min_concentration)
